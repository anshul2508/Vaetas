...
var LoginComponent = (function () {
    function LoginComponent(invidz, router) {
        this.invidz = invidz;
        this.router = router;
        this.loading = false;
    }
    LoginComponent.prototype.ngOnInit = function () {
        this.loginData = new forms_1.FormGroup({
    ...
    LoginComponent.prototype.onSubmit = function () {
        var _this = this;
        this.loading = true;
        var output = this.invidz.login(this.loginData.get('email').value, this.loginData.get('password').value);
